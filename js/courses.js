...
function getCourses() {
    return __awaiter(this, void 0, void 0, function () {
        var url, query, options, response, jsonResponse, data, courses, coursesTableBody_1, error_1;
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (data.GetCourses) {
                        ...
                        coursesTableBody_1 = document.getElementById("myTable").children[1];
                        courses.forEach(function (course) {
                            var row = document.createElement("tr");
                            row.innerHTML = "\n        <td><a href=\"courseDetails.html?courseId=".concat(course._id, "\">").concat(course._id, "</a></td>\n        <td>").concat(course.name, "</td>\n        <td>").concat(course.isActive, "</td>\n        <td>").concat(new Date(course.lastPaymentGeneration).toLocaleString(), "</td>\n        \n    ");
